    ...
    <Layout>
      ...
      <article className="content">
        <div className="center">
          ...
          <Description left change width="half">
            <Trans>
              篠原まるよし風鈴では江戸風鈴を中心に、その技術を応用してイヤリング、ぽっぺんなども制作しております。風鈴の絵柄の意味なども一つ一つ紹介しているので是非ご覧ください。
            </Trans>
            <br />
            <br />
            <Trans>
              直接お店に出向かなくても、オンラインショップもやっているのでご購入をご希望の方はこちらからよろしくお願い致します。
            </Trans>
            <br />
          </Description>
          <Button onClick={onlineOpen}>
            <Trans>オンラインショップ</Trans>
          </Button>
        ...
        <Product
          isEn={isEn}
          data={data.fuurin}
          description="風鈴には小丸、新子丸、釣鐘型のように大きさが違う種類のものがあり、様々な縁起の良い絵柄が描かれます。あなたのお部屋にあったものを豊富な品揃えの中からお探しください。"
          title="江戸風鈴"
          destination="/fuurin"
          num="0"
        />
        ...
        <Product
          data={data.earring}
          description="イヤリング・ピアスは風鈴と同じように内側から絵が描かれます。音も少し鳴るものもあり、浴衣やお着物などには特に相性が良くおすすめの一品です。"
          title="イヤリング"
          destination="/fuurin"
          num="1"
          reverse="true"
        ...
        <Product
          data={data.poppen}
          description="ポッペンはビードロともう呼ばれ、ガラスの弾力性を使った唯一の工芸品です。 単純なガラスの玩具ではなく、お正月に吹いて一年の厄を祓うという意味もあります"
          title="ポッペン"
          destination="/fuurin"
          num="2"
        />
        ...
        <Product
          data={data.kit}
          description="体験キットがあれば自宅にいても江戸風鈴の体験が楽しむことができます。絵の描き方なども説明してあるので充実した体験を提供いたします。"
          title="体験キット"
          destination="/fuurin"
          num="3"
          reverse="true"
        ...
        <Product
          data={data.tsuridai}
          description="風鈴を飾る場所がない、もう少しカッコ良く飾りたい方に吊り台はおすすめです。まるよし風鈴では照明とセットになった行灯型のものも販売しております。"
          title="吊り台"
          destination="/fuurin"
          num="4"
        />
