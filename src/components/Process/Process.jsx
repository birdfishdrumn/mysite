    ...
    <div className="center">
      ...
      <ProcessGrid>
        {array.map((item, index) => {
          if(index % 2 !== 0){
            return  <ProcessCard data={data} reverse="true" description="jj これが風鈴の鳴り口部分となり、口玉と言います。"/>
          } else {
              return <ProcessCard data={data} description="1300℃で溶けたガラスを小さく巻き取る。 これが風鈴の鳴り口部分となり、口玉と言います。"/>
          }
