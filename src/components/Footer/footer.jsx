  ...
  return (
    <FooterWrapper>
      ...
      <FooterContainer>
        ...
        <ContactIcon>
          <Description large color="white" left>
            <PhoneIcon style={{ fontSize: 40 }} /> 03-3832-0227
          </Description>
          <Description color="white" style={{ fontSize: "0.9rem" }} small left>
            受付時間 10:30〜18:00
          </Description>
          <Description large color="white" left>
            <MailIcon style={{ fontSize: 40 }} /> maruyosi@sam.hi-ho.ne.jp
          </Description>
      ...
      <Privacy>
        <p>
          <Link to="/privacy">個人情報のお取り扱いに関しまして</Link>
        </p>
