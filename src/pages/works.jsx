  ...
  return (
    <Layout>
      ...
      <div className="hero">
        <figure>
          <Img
            fluid={data.taiken.childImageSharp.fluid}
            style={{ height: "100%" }}
            alt="製品情報"
          />
        </figure>
      ...
      <article className="content">
          ...
          <div>
            <DescriptionFlex>
              <Description noneMargin width="more" left>
                <br /> <br />
                <Trans>
                  まるよし風鈴では家族4人で主に江戸風鈴の製作をしております。年間で12000個ほど職人の手作業によって作られます。
                </Trans>
                <br />
                <Trans>
                  私どもの作る江戸風鈴は、江戸時代の享保(300年前)より現代まで受け継がれた技術で作り続けております。
                </Trans>
                <br />
                <br />
                <Trans>
                ...
                <br />
                <Trans>
                  この風鈴技術は日本のガラス工芸で最も古い技術の一つであり、日本中でたった二軒が継承しているのみであります。
                </Trans>
              </Description>
              <SubTitle data-aos="fade-up" noSpace>
                <Trans>江戸風鈴の製作</Trans>
              </SubTitle>
            </DescriptionFlex>
          </div>
          ...
          <div>
            <DescriptionFlex>
              <Description width="more" left>
                <br />
                <Trans>
                  この風鈴市では、日本全国から集まった色々な風鈴が販売されます。ここではたくさんの風鈴たちが訪れたお客様を癒してくれるでしょう。
                </Trans>
                <br />
                <br />
                <Trans>
                  もともとは風鈴には夏の暑い日にその音色で風を楽しむ、といった使い方があります。
                </Trans>
                <br />
                <br />
                <Trans>
                ...
                <br />
                <Trans>
                  その思いが叶い、無事に一年を過ごされるように心を込めて製作しています。
                </Trans>
              </Description>
              <SubTitle data-aos="fade-up" noSpace>
                <Trans>川崎大師風鈴市</Trans>
        ...
        <MaxTwoColumn auto>
          <div>
            <Figure data-aos="fade-up">
              <Image filename="hikawa.jpg" alt="" style={{ width: "100%" }} />
            </Figure>
          </div>
          <div>
