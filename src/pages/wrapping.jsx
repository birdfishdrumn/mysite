      ...
      <Layout>
        ...
        <article className="content">
            ...
            <TwoColumn reverse>
              ...
              <div>
                <Description left width="more">
                  <Trans>
                    篠原まるよし風鈴でお買い上げいただいたお客様、体験をおやりになったお客様の風鈴は全て割れないようにパッキンや箱でお包み致します。体験をおやりになったお客様は結構箱に入るのか不安に思われるようですがご安心ください。
                  </Trans>
                  <br />
                  <br />
                  <br />
                  <Trans>
                    箱の種類は小丸型の風鈴の場合は基本的には白い無地の箱と江戸風鈴のシールの付いた箱にお入れいたします。
                  </Trans>
                  <br />
                  <Trans>
                    切子の風鈴やじんべえ鮫、釣鐘型など少し高価な風鈴に関しては写真下のような化粧箱にお入れさせていただきます。
                  </Trans>
                </Description>
              </div>
            </TwoColumn>
          ...
          <section>
            ...
            <MinTitle>
              <Trans>※海外への発送に関しまして</Trans>
            </MinTitle>
            <Description left width="half">
              <Trans>
                当店から直接では海外への発送は行っておりませんがご希望の方はお問い合わせフォーム、お電話、メールにてご相談くださいませ。これまでもフランスやニュージーランド、タイの方々などにもお取引の実績もございます。
              </Trans>
            </Description>
          </section>
        </article>
