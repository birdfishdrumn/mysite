  ...
  return (
    <div>
      <article className="content center">
        ...
        <MinTitle custom large>
          ①風鈴の音から選ぶ
        </MinTitle>
        {/* <Image filename="river.jpg" style={{width:"50%",margin:"30px auto"}} /> */}
        <Description left width="half">
          <MinTitle black borderLeft left>
            風鈴の音の選び方
          </MinTitle>
          <br />
          <Trans>
            まず最初に①に関してですが、風鈴はやはり音が大事ですよね。
            難しいことは省きますが風鈴の音には、1/fのゆらぎと呼ばれる人間にとって気持ちの良い周波数が感じられるといいます。これは自然界に存在している例でいうと川のせせらぎ、小鳥のさえずり、揺れては返す波の音、どれも思い出すだけでも心が落ち着いてきますよね。
            <br />
            <br />
        ...
        <Description left width="half">
          ...
          <Trans>
            ...
            今より厳しい状況でした。そうした願いをもとにアマビエ様は海から現れて、写し絵を見せると疫病が治癒すると云ったのかもしれませんね。
            <br />
        ...
        <Description left width="half">
          ...
          <Trans>
            ...
            <br />
            <br />
            三匹金魚の柄は言わずと知れた風鈴で良く見る柄で一番人気の高い柄です。赤・緑・青の夏らしい３色を使ってこの風鈴の絵柄は描かれます。値段は江戸風鈴の中では手頃で絵も可愛い、また金運という意味もあるのでおすすめです。
            <br />
            <br />
