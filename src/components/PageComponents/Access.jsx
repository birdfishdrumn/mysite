    ...
    <div>
      <section>
        ...
        <TwoColumn>
          <div>
            ...
            <Description left>
              <Trans>
                お店は佐竹商店街の中にあります。普段からお店の前には風鈴を飾っております。
                一階は基本的には仕事場で作業中なので少し入り辛いと思いますが、風鈴の販売もやっておりますので、
                是非お気軽にご来店下さい。
              </Trans>
              <br />
              <br />
              <Trans>
                またガラス吹き体験では一階奥の工房で最初にガラスを吹いていただきます。二階は主に絵付け体験の会場となっております。
              </Trans>
            </Description>
          </div>
          <div>
      ...
      <section className="center">
        ...
        <Nav small>
          ...
          <p>
            大塚駅　⇄　錦糸町駅(経由・春日駅・御徒町駅都バス
            )のバスにお乗り頂き、新御徒町前で下車してください。
          </p>
        </Nav>
        <SubTitle>車でお越しの方</SubTitle>
        <Nav small>
          <p>
            お店には駐車場がないので、申し訳ありませんが、お近くの白線などに駐車お願い致します。
          </p>
        </Nav>
      </section>
      <div className="space-l" />
