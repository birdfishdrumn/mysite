...
import { GridList, FlexNav, SubTitle, ScrollItem, Description,Figure, TwoColumn } from "../../style/GlobalStyle";
...
`)
  ...
  return (
      ...
      <section className="center">
              <SubTitle><Trans>ポッペン</Trans></SubTitle>
          <Description  left width="half">
      <Trans>ポッペンは、ガラスの弾力性を使った唯一の工芸品です。お正月（年頭）に吹いて一年の厄を祓う。(※旧正月や節分を年の初めとして考える方が多いです。)ポッペンの絵は外側から一つずつ描かれます。</Trans>
        ...
        <div className="space-l"/>
          ...
          <div>
            <Description left noSpace>
              <Trans>ポッペンは底の部分がとても薄くなっていて、細い棒の部分を咥えて息を入れると”ポッ”凸咥えている口を放すと”ペン”凹と音が出ます。</Trans>
              <br /><br /><br />
              <Trans>ポッペンは音を鳴らすだけの玩具ではなく、この音で一年の厄を追い祓うと言う意味で日本全国にひろがったようです。</Trans>
<br /><Trans>歌麿の浮世絵の中に”ビードロを吹く女”という有名な作品が あります。寛政4年‐寛政5年頃(西暦1792〜1793年頃)に当時の流行を取り入れた町娘を描いた浮世絵師・喜多川歌麿(1753〜1806年)の作品です。この町娘が吹いてるのまさにビードロ、ぽっぺんであり舶来品でその時代の流行品でした。</Trans><br /><br /><br /><Trans>この作品の名前があまりにも有名になってしまい現在でもポッペンのことをビードロと言う人が多くいます。</Trans>
            </Description>
        ...
        <section>
         <SubTitle hannari><Trans>いろいろなポッペン</Trans></SubTitle>
           <FlexNav>
        ...
        <GridList change={change}>
          ...
          <section>
            <SubTitle hannari><Trans>ぽっぺんの作り方</Trans></SubTitle>
