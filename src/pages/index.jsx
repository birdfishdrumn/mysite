  ...
  return (
    <Layout>
      <SEO
        ...
        pagedesc={t(
          "篠原まるよし風鈴では伝統工芸である江戸風鈴を東京都台東区で製作しております。江戸風鈴の製作体験、販売にも力を入れておりますので、上野、御徒町、浅草などへ観光の方は是非お立ち寄りください"
        )}
      />
      ...
      <Featured>
        <div>{/* <Sironuki src={Siro} /> */}</div>
        <Content>
          <Trans>風を音に変える</Trans>
        </Content>
        <div className="center">
          <Description large left width="half">
            <Trans>
            ...
            <br />
            <Trans>
              一つ一つ職人が気持ちを込めて作った風鈴は、ガラスならではの涼しげでリラックスできる軽やかな音と優しい絵柄で見る人を癒してくれるでしょう。暑い夏にゆったりしながら、そっと風鈴の音に耳を傾けてみませんか？
            </Trans>
            <br /> <br /> <br />
            <Trans>
