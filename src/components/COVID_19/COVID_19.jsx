      ...
      >
        ...
        <DialogContent dividers>
          <Typography gutterBottom>
            <Description left>
              私達なりに感染の不安を少しでも和らげて風鈴のご購入や、体験を楽しんでいただけますようにいくつか対策を考えました。もうコロナが広がってから1年以上たって慣れてしまいましたが、引き続き感染対策のご協力をお願い致します。
            </Description>
          </Typography>
              ...
              {shopPlan.map(item => (
                <>
                  <div>
                    ...
                    <MinTitle small>{item.title}</MinTitle>
                    <MinDescription>{item.description}</MinDescription>
                  </div>
                </>
              ))}
            </GridList>
