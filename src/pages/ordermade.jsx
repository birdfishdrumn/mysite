    ...
    <div>
      <Layout>
        ...
        <article className="content">
          <SubTitle>
            <Trans>江戸風鈴の名入れ</Trans>
          </SubTitle>
          <Description left width="half">
            <Trans>
              篠原まるよし風鈴では江戸風鈴の名入れを承っております。ご希望のお名前を職人が一つ一つ墨で書き、背景にぼかしの入った短冊模様を入れて制作致します。大切な方のへのプレゼント、何か企画のお名前を入れたりイベントなどにもオススメです。
            </Trans>
            <br />
          </Description>
          <TwoColumn reverse>
            <div>
              <Description large left>
                <TextNav style={{ marginTop: "30px" }} className="center">
                  ...
                  <p>
                    <Trans>
                      オンラインショップよりご購入希望の商品と名入れの商品を一緒にお入れください。ご希望の名前は備考欄にお書きください。
                    </Trans>
                  </p>
                </TextNav>
              </Description>
          ...
          <section>
            <SubTitle>
              <Trans>風鈴のオーダーメイドについて</Trans>
            </SubTitle>
            <TwoColumn>
              <div style={{ marginBottom: "0" }}>
                <Description left>
                  <Trans>
                    新しい模様はデザインを決めたり、内側から描くのに大丈夫かな？なんてことを準備しなくてはなりません。したがって通常のものより高価になります。
                  </Trans>
                  <br />
                  <br />
                  <Trans>
                    ５個前後の場合は一つ約3000〜4000円ほど、また一点ものの場合はもう少し高くなります。詳しくはメールやお電話で詳しくはお問い合わせ下さいませ。
                  </Trans>
